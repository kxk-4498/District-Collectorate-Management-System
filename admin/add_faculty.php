...
$q=mysqli_query($conn,"select * from faculty where email='$email'");
	...
	{	
		mysqli_query($conn,"insert into faculty values('','$user_name','$name','$Designation','$email','$pass','$mob',now(),'0')");
	...
	$err="<font color='green'>New Officer Successfully Added.</font>";
	}
	}
}	
...
<div class="col-lg-8" style="margin:15px;">
	...
	<div class="control-group form-group">
    	<div class="controls">
            	<input type="submit" class="btn btn-success" name="save" value="Add New Officer">
        </div>
  	</div>
	</form>

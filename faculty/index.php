        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="index.php?page=update_profile"><span class="glyphicon glyphicon-asterisk"></span> Update Profile</a></li>
			 <li><a href="index.php?page=feedback"><span class="glyphicon glyphicon-thumbs-up"></span> Request</a></li>
            <li><a href="index.php?page=feedback_approval"><span class="glyphicon glyphicon-pencil"></span> Request Approval</a></li>
			<li><a href="index.php?page=status"><span class="glyphicon glyphicon-ok"></span> Status</a></li>
          </ul>
